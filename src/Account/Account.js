        ...
        <>
            <div className="register-page">
                <div className=" register-form-container">
                    <h1 className="title" > <i className="fa-solid fa-user-secret" > logn in</i></h1>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div>
                            <button type="button" className="submit-btn2" onClick={handlogin}>Log in

                            </button>

                            <button className="submit-btn2" ><Link to="/register" >register</Link>
